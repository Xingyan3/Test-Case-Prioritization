...
def total_statement(bm):
  ...
  os.system('rm -rf my_test_suite.txt')
...
def main():
  ...
  if args.prioritization == 'baseline' and args.criteria == 'statement':
    for bm in benchmarks:
      baseline_statement_coverage(bm)

  if args.prioritization == 'total_cov' and args.criteria == 'statement':
    for bm in benchmarks:
      total_statement(bm)
